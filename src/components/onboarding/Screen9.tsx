...
function pickEmoji(choice?: string) {
    if (!choice) return "✨";
    if (choice === "Being with someone") return "🤝";
    if (choice === "Feeling understood") return "🫶";
    if (choice === "Doing something with my hands") return "🛠️";
    if (choice === "Being outside") return "🌿";
    if (choice === "Having no pressure") return "😌";
    return "🤷";
}

export function Screen9({ onNext, onBack, userData, updateUserData }: Screen9Props) {
    const initial = typeof userData?.momentFeelGoodReason === "string" ? userData.momentFeelGoodReason : "";
    ...
    const handleContinue = () => {
        updateUserData("momentFeelGoodReason", selected);
        onNext();
    };
    ...
    return (
        <div className="min-h-screen flex flex-col px-6 py-12">
            ...
            >
                ...
                <h1 className="mb-3">What do you think made this moment feel good?</h1>
