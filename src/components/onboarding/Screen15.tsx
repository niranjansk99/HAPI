...
function pickEmoji(choice?: string) {
    if (!choice) return "🧭";
    if (choice === "Feeling connected to others") return "🫂";
    if (choice === "Feeling calm and without pressure") return "😌";
    if (choice === "Giving something to others") return "🎁";
    if (choice === "Having direction, even if small") return "🧭";
    return "🤷";
}
...
export function Screen15({
    ...
    const initial =
        typeof userData?.mostTrueParts === "string" ? userData.mostTrueParts : "";
    ...
    const handleContinue = () => {
        updateUserData("mostTrueParts", selected);
        onNext();
    };
    ...
    return (
        <div className="min-h-screen flex flex-col px-6 py-12">
            ...
            >
                ...
                <h1 className="mb-3">What parts of your answers felt most true to you?</h1>
                <p className="text-gray-600">
                    Choose the one that feels closest — you can always change it later.
                </p>
            </motion.div>
